...
class SpacerTile extends StatefulWidget { // Changed to StatefulWidget for wishlist state
  ...
  @override
  State<SpacerTile> createState() => _SpacerTileState();
}

class _SpacerTileState extends State<SpacerTile> {
  bool _isLiked = false;
