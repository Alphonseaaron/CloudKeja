            ...
            children: [
              ...
              Padding(
                ...
                child: GridView.count(
                  crossAxisCount: MediaQuery.of(context).size.width > 600 ? 4 : 2, // Adjusted for 4 cards
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                  crossAxisSpacing: 12,
                  mainAxisSpacing: 12,
                  childAspectRatio: 1.15, // Adjusted for potentially taller cards if value is empty
                  children: [
                    ...
                    _buildStatCard(
                      context, 
                      icon: Icons.chat_bubble_outline_rounded, // New chat icon
                      value: "View", // Placeholder value, or use an actual count if available
                      label: 'My Chats', 
                      iconColor: colorScheme.tertiary, // Use tertiary color for distinction
                      onTap: () {
                        Get.to(() => const ChatScreen()); // Navigate to ChatScreen
                      },
                    ),
                  ],
                ),
              ...
              if (_isLoading && _assignedTasks.every((t) => t.id.startsWith('skel-')))
                ListView.builder(
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                  itemCount: 3, 
              ...
              else if (!_isLoading && _assignedTasks.isEmpty)
                Padding(
